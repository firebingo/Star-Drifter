...
public class GridManager : MonoBehaviour
{
    ...
    {
        get { return new Vector3(-25.5f,-21.5f,0); }
    }
    ...
    {
        nodes = new Node2[numOfColumns, numOfRows];
        int index = 0;
    ...
    public void GetNeighbours(Node2 node, ArrayList neighbors)
    {
    ...
    void AssignNeighbour(int row, int column, ArrayList neighbors)
    {
        ...
        {
            Node2 nodeToAdd = nodes[row, column];
    ...
    void OnDrawGizmos()
    {
        ...
        {
            Vector3 cellSize = new Vector3(gridCellSize, 
            gridCellSize,1.0f);
            if (obstacleList != null && obstacleList.Length > 0)
            {
                foreach (GameObject data in obstacleList)
